...
class AkunController extends \BaseController {
    ...
    public function listakun($rombelId) {
        ...
        // return \View::make('master.akun.listakun')
        //                 ->with('siswas', $siswas)
        //                 ->with('isall', ($rombelId == -1 ? true : false));

        return \View::make('master.akun.listakun',[
                                'siswas' => $siswas,
                                'isall' => ($rombelId == -1 ? true : false),
    ...
    public function show($id) {
        ...
        $tapelAktif = \App\Models\Tapel::whereAktif('Y')->first();
        // return \View::make('master.akun.show')->with('siswa', $siswa);
        return \View::make('master.akun.show',array(
                'siswa' => $siswa,
                'tapelAktif' => $tapelAktif
            ));
    }
