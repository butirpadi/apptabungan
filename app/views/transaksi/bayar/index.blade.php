    ...
    <div class="widget ">
        ...
        <div class="widget-content">
            <div class="alert alert-info" >
                {{ Form::open(array('method' => 'post', 'route' => array('transaksi.bayar.create'),'class'=>'form-horizontal')) }}
                <table class="table table-form">
                    <tbody>
                        <tr>
                            ...
                            <td> 
                                {{ Form::submit('Proses', array('class'=>'btn btn-success')) }}
                            </td>
...
//                jQuery('#btn-detil-akun').attr('href', "{{ URL::to('master/akun') }}" + "/" + siswaid);
        ...
        jQuery(document).on('focus', 'input[name=namasiswa]', function() {
            ...
            var getListsiswaUrl = "{{ URL::to('transaksi/debet/datasiswa') }}";
